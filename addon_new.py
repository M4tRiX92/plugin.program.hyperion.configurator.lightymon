...
def setEverything(hled, vled, index, center_to, device):
    ...
    if(hled != None):
        ...
        try:
            ...
            print("That's all! Now we will attempt to restart hyperion...")
            ...
            print(repr(e) + " Please report an error at github issue list")
